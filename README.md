...
4. If the user doesn't type an answer AT ALL, a message will display below the submit button "Please enter a number". Refer back to steps 2 & 3 once user types solution. 
